...
ls -lh 05-revenue-flow.svg m1-marketplace-structure.svg m3-payment-base-structure.svg p1-cloud-structure.svg revenue-flow-diagram.svg wealth-creation-model.svg 2>/dev/null

echo ""
echo "Removing old broken SVG files (requires sudo password)..."
sudo rm -f 05-revenue-flow.svg \
           m1-marketplace-structure.svg \
           m3-payment-base-structure.svg \
