...
style: |
  ...
  strong {
    color: #FF1EFF;
    font-weight: 700;
    text-shadow: 0 0 8px #FF1EFF;
  }
  .hero {
    text-align: center;
    padding: 100px 80px;
    background: radial-gradient(circle, #1a0d2e 0%, #0d0d1a 100%);
  }
  .hero h1 {
    font-size: 64px;
    margin-bottom: 20px;
  ...
  .highlight {
    background: linear-gradient(135deg, #1a0d2e 0%, #2d1b4e 100%);
    padding: 20px 30px;
    border-left: 6px solid #FF1EFF;
    border-radius: 8px;
    margin: 20px 0;
    font-size: 20px;
    color: #FF1EFF;
    box-shadow: 0 0 20px rgba(255, 30, 255, 0.3);
  }
  .grid-2 {
    display: grid;
  ...
  .success {
    background: linear-gradient(135deg, #1a3d2e 0%, #0f2818 100%);
    border: 2px solid #00FF41;
    padding: 25px 35px;
    border-radius: 12px;
    margin: 20px 0;
  ...
  .gold {
    background: linear-gradient(135deg, #4d1a3d 0%, #2e0f2e 100%);
    border: 2px solid #FF1EFF;
    padding: 25px 35px;
    border-radius: 12px;
    margin: 20px 0;
    font-size: 20px;
    font-weight: 600;
    color: #FF1EFF;
    box-shadow: 0 0 25px rgba(255, 30, 255, 0.5);
  }
  code {
    background: #0d0d1a;
    color: #00FF41;
