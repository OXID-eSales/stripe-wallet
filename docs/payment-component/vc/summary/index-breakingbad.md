...
style: |
  section {
    ...
    padding: 60px 80px;
    color: #e8dcc4;
    background: linear-gradient(135deg, #2e2920 0%, #1a1612 100%);
  }
  h1 {
    color: #ABED3B;
    font-size: 56px;
  ...
  .hero {
    text-align: center;
    padding: 100px 80px;
    background: radial-gradient(circle, #3d3528 0%, #2e2920 100%);
  }
  .hero h1 {
    font-size: 64px;
    margin-bottom: 20px;
  ...
  .stat-box {
    background: linear-gradient(135deg, #3d3528 0%, #2e2412 100%);
    border: 2px solid #ABED3B;
    color: #e8dcc4;
    padding: 30px;
    border-radius: 5px;
    text-align: center;
  ...
  .metric.bright-yellow {
    background: linear-gradient(135deg, #d9a740 0%, #c77c32 100%);
    border: 2px solid #ABED3B;
  }
  ...
  .metric.bright-green {
    background: linear-gradient(135deg, #ABED3B 0%, #8fb82e 100%);
    border: 2px solid #6d8920;
  }
  ...
  .success {
    background: linear-gradient(135deg, #7fa030 0%, #6d8920 100%);
    border: 2px solid #ABED3B;
    padding: 25px 35px;
    border-radius: 5px;
    margin: 20px 0;
