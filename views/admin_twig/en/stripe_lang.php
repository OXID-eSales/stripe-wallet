...
$aLang = array(
    ...
    // read from the Stripe charge (OXPAYMENTTYPE only ever says 'oscstripe').
    'STRIPE_PAYMENT_METHOD_USED'                        => 'Payment method used',
    ...
    'STRIPE_PAYMENT_METHOD_SEPA_DEBIT'                  => 'SEPA direct debit',
    'STRIPE_PAYMENT_METHOD_US_BANK_ACCOUNT'             => 'Bank account (ACH)',
    'STRIPE_PAYMENT_METHOD_CUSTOMER_BALANCE'            => 'Customer balance',
