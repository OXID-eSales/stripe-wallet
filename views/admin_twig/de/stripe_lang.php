...
$aLang = array(
    ...
    // Sprint 136 (STRP-TBD): die tatsächlich verwendete Zahlungsart aus dem
    // Stripe-Charge (OXPAYMENTTYPE liefert immer nur 'oscstripe').
    'STRIPE_PAYMENT_METHOD_USED'                        => 'Verwendete Zahlungsart',
    'STRIPE_PAYMENT_METHOD_CARD'                        => 'Kreditkarte',
    'STRIPE_PAYMENT_METHOD_APPLE_PAY'                   => 'Apple Pay',
    'STRIPE_PAYMENT_METHOD_GOOGLE_PAY'                  => 'Google Pay',
    'STRIPE_PAYMENT_METHOD_LINK'                        => 'Link',
    'STRIPE_PAYMENT_METHOD_KLARNA'                      => 'Klarna',
    'STRIPE_PAYMENT_METHOD_AFTERPAY_CLEARPAY'           => 'Clearpay / Afterpay',
    'STRIPE_PAYMENT_METHOD_PAYPAL'                      => 'PayPal',
    'STRIPE_PAYMENT_METHOD_REVOLUT_PAY'                 => 'Revolut Pay',
    'STRIPE_PAYMENT_METHOD_ALIPAY'                      => 'Alipay',
    'STRIPE_PAYMENT_METHOD_WECHAT_PAY'                  => 'WeChat Pay',
    'STRIPE_PAYMENT_METHOD_TWINT'                       => 'TWINT',
    'STRIPE_PAYMENT_METHOD_SEPA_DEBIT'                  => 'SEPA-Lastschrift',
    'STRIPE_PAYMENT_METHOD_US_BANK_ACCOUNT'             => 'Bankkonto (ACH)',
    'STRIPE_PAYMENT_METHOD_CUSTOMER_BALANCE'            => 'Kundenguthaben',
    'STRIPE_PAYMENT_METHOD_MULTIBANCO'                  => 'Multibanco',
    'STRIPE_PAYMENT_METHOD_SOFORT'                      => 'Sofort',
    'STRIPE_PAYMENT_METHOD_GIROPAY'                     => 'giropay',
    'STRIPE_PAYMENT_METHOD_EPS'                         => 'EPS',
    'STRIPE_PAYMENT_METHOD_P24'                         => 'Przelewy24',
    'STRIPE_PAYMENT_METHOD_IDEAL'                       => 'iDEAL',
    'STRIPE_PAYMENT_METHOD_BANCONTACT'                  => 'Bancontact',
);
