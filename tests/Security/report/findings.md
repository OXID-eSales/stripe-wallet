...
| Profile | `aggressive` |
| Findings | 21 (13 pass · 6 fail · 2 skip) |
...
| HDR-hsts | low | fail | Missing Strict-Transport-Security | no HSTS over HTTPS |
| HDR-nosniff | low | fail | Missing X-Content-Type-Options: nosniff |  |
| HDR-frame | low | fail | Missing clickjacking guard | no X-Frame-Options / CSP frame-ancestors |
| HDR-banner | low | fail | Server/version banner leaked | Server='Apache/2.4.68 (Unix) OpenSSL/3.5.7' X-Powered-By='PHP/8.3.31' |
...
| M7-rate | med | fail | No webhook rate limiting observed | 0/120 got 429 |
| BF-login | med | fail | No login brute-force throttling observed | 30 bad logins, none throttled |
